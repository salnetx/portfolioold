...
const Linkinbio = ()=>{
   return(
    ...
    <div className="border flex grid grid-cols-5 rounded-lg shadow border-black border-t-2 border-l-2 hover:rounded">
          <div className="translate-y-4 pl-8"> <Image width="30" height="30" src="/twitter.png" /></div>
        <h3 className="text-center py-5 col-end-4 pl-2">Twitter</h3>
    </div>

    <div className="border flex grid grid-cols-5 rounded-lg shadow border-black border-t-2 border-l-2 hover:rounded">
          <div className="translate-y-4 pl-8"> <Image width="30" height="30" src="/instagram.png" /></div>
    ...
    <div className="border flex grid grid-cols-5 rounded-lg shadow border-black border-t-2 border-l-2 hover:rounded">
          <div className="translate-y-4 pl-8"> <Image width="30" height="30" src="/github.png" /></div>
        <h3 className="text-center py-5 col-end-4 pl-2">Github</h3>
    </div>

    <div className="border flex grid grid-cols-5 rounded-lg shadow border-black border-t-2 border-l-2 hover:rounded">
          <div className="translate-y-4 pl-8"> <Image width="30" height="30" src="/css.png" /></div>
